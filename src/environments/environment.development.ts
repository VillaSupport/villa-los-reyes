export const environment = {
  ...
  business: {
    email: 'villalosreyes.booking@gmail.com',
    whatsapp: '5351234567', // Solo números para el enlace de wa.me
    phoneDisplay: '+53 51234567', // Como se verá escrito en la web
    address: 'Calle Salvador Cisneros # 206-C, Viñales, Pinar del Río, Cuba'
  }
};
